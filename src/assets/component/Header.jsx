...
const Header = () => {
  return (
    <div className={`bg-banner bg-no-repeat bg-left-top object-cover w-full h-[600px] py-10 flex flex-col`}>
      <div className='flex items-center justify-between pr-3 md:pr-40'>
        ...
        <div>
          <ul className='flex items-center gap-5'>
            {navMenu.map((nav, idx) => <li key={idx} className='hover:text-[15px]'>
      ...
      <h1 className='text-[3.2rem] md:text-[5rem] font-bold md:max-w-xl leading-[5rem] mt-[6rem] ml-2 md:ml-10'>Explore Beyond Earth..</h1>
    </div>
  )
