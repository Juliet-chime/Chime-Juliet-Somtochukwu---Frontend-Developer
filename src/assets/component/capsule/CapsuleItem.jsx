...
const CapsuleItem = ({ item, ...props }) => {
  const imgSrc =
    item?.type === 'Dragon 1.0'
      ? dragon1
      : item?.type === 'Dragon 1.1'
      ? dragon2
      : item?.type === 'Dragon 2.0'
      ? dragon3
      : dragon4;
  return (
    <div
      className="w-full md:w-56 lg:w-[240px] xl:w-[240px] border-[1px] border-[#ffffff4d] rounded-md cursor-pointer"
      {...props}
    >
