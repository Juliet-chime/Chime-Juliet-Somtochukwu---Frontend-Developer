    ...
    <div className="mt-5">
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-16">
        <div className="h-72 relative">
          ...
          <p
            className={`absolute top-3 right-3 ${rocket?.active ? 'text-[#9ee9bd]' : 'text-[#e6cfcf]'} ${
              rocket?.active ? 'bg-[#00a67e]' : 'bg-[#fa113d]'
            ...
            <div className="mt-4">
              ...
              <span>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-[#f690a3] text-[12px] font-bold"
                >
                  Read More
                </a>
              </span>
